...
local function on_attach(client)
  do
    local _0_ = client
    completion.on_attach(_0_)
    lsp_status.on_attach(_0_)
  end
  return nil
end
...
return nvim_lsp.clangd.setup(utils["merge-tables"](default_options, {settings = {root_dir = lsp_util.root_pattern("build", "compile_commaonds.json")}}))
